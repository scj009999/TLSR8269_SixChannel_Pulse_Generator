...
=======
 ...
 PA5 │ 6  43 │ PC2
 PB0 │ 7  42 │ PC3
 PB1 │ 8  41 │ PC4 ← TX (调试串口)
>>>>>>> 25da801773c8ff645ef9347320ff7b7be9e0631f
 ... │ ...   │ ...
 └─────────────────┘
...
脉冲输出引脚：
 ...
 CH2 → PA2 (Pin 3) - PWM2
 CH3 → PA3 (Pin 4) - PWM3
 CH4 → PB0 (Pin 7) - PWM4  ✅ QFN32封装
 CH5 → PB1 (Pin 8) - PWM5  ✅ QFN32封装
```
...
本项目提供完整的 Arduino Core 支持，包括：

### 引脚定义 (pins_arduino.h)
- **QFN32 封装支持**：`firmware/arduino_core/TLSR8251F512ET32_pins_arduino.h`
- **作者**：束老师 (用户贡献)
- **功能**：24个可用GPIO，6路硬件PWM，6路ADC
